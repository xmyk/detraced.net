// Hello dear detraced.net source code inspector, you have stumbled upon script.js :crazy:.
// If you steal anything, consider yourself gay.
...
function startBlinking() {
    blinkInterval = setInterval(() => {
        mainTitle.style.color = isBlinking ? '#00008b' : 'white'; 
...
function create_star(x, y, probability = 1.0) {
    ...
    if (min_index >= 0) {
        ...
        star[min_index].childNodes[0].style.backgroundColor =
            star[min_index].childNodes[1].style.backgroundColor = "#00008b";
